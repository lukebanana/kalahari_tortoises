...
function kalahri_process_html(&$variables) {
...
function kalahri_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function kalahri_button($variables) {
 ...
 */
function kalahri_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function kalahri_menu_local_task($variables) {
 ...
 */
function kalahri_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function kalahri_node_preview($variables) {
  $node = $variables['node'];
