...
function kalahri_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function kalahri_feed_icon($url, $title) {
 ...
 */
function kalahri_preprocess_comment_wrapper(&$vars) {
 ...
 */
function kalahri_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function kalahri_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function kalahri_button($element) {
...
*/
function kalahri_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function kalahri_node_preview($node) {
