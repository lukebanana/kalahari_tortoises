 ...
 * @ingroup themeable
 */
function kalahri_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function kalahri_feed_icon($url) {
 ...
 */
function kalahri_comment_wrapper($content, $type = null) {
  static $node_type;
